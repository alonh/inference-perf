...
ReplayGraphSession objects; this base class handles session lifecycle, worker
...
class ReplayGraphSessionGeneratorBase(SessionGenerator, LazyLoadDataMixin):
    ...
    def __init__(
        ...
        self.sessions: List[ReplayGraphSession] = []
        self.session_graph_state: Dict[str, ReplayGraphSessionState] = {}
        self.all_events: List[ReplayGraphSessionEvent] = []

    def initialize_sessions(self, sessions: List[ReplayGraphSession]) -> None:
    ...
    def get_session_state(self, session_id: str) -> Optional[ReplayGraphSessionState]:
